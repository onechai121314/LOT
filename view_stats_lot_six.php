...
$query = "SELECT view_date, view_count FROM lot_six_views ORDER BY view_date DESC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
    ...
    $stmt = $db->prepare("DELETE FROM lot_six_views WHERE view_date = :view_date");
...
<div class="container">
    ...
    <h1>สถิติการเข้าชมหน้าเว็บของ สถิติเลข 6 หลัก</h1>
    ...
    <table border="1">
        ...
        <tbody>
            <?php foreach ($LotSixViews as $view): ?>
                <tr>
...
<footer>
    ...
    <script>
        ...
        const viewsChart = new Chart(ctx, {
            ...
            data: {
                labels: <?php echo json_encode(array_column($LotSixViews, 'view_date')); ?>, // วันที่
                datasets: [{
                    label: 'จำนวนครั้ง',
                    data: <?php echo json_encode(array_column($LotSixViews, 'view_count')); ?>, // จำนวนครั้ง
