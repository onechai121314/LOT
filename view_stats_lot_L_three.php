...
$query = "SELECT view_date, view_count FROM lot_last_three_views ORDER BY view_date DESC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete'])) {
    ...
    $stmt = $db->prepare("DELETE FROM lot_last_three_views WHERE view_date = :view_date");
...
<div class="container">
    ...
    <h1>สถิติการเข้าชมหน้าเว็บของ  สถิติเลขหน้า 3 ตัว</h1>
